...
import { Pencil, Upload, Link, ExternalLink } from "lucide-react";
      ...
      <DialogContent className="max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="space-y-4 overflow-y-auto flex-1 min-h-0 pr-1">
              ...
              {isCustomCategory ? (
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="sm"
                    onClick={() => { setIsCustomCategory(false); setForm({ ...form, category: resource.category }); }}
                  >
                    Cancelar
                  </Button>
                </div>
          ...
          <div>
            ...
            {(resource.file_url || resource.external_url) && !uploadedFileUrl && !form.file_url && !form.external_url ? null : (
              (resource.file_url || uploadedFileUrl || form.file_url) && (
          ...
          <Button
            ...
            disabled={!form.title || !form.category || !form.type || updateMutation.isPending || uploading}
          >
