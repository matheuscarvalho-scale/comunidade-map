...
DECLARE
  ...
  internal_ids uuid[] := ARRAY[
    ...
    '297e25c2-fb4e-47ad-a8da-bdf0b4c70ebf'::uuid, -- Anna Vieira
    '634f99e0-131b-481c-816d-c14301568fe7'::uuid, -- Ingrid Medeiros
    'b7783f1f-5e44-46ad-b1f9-17fe451d0689'::uuid  -- José Arthur Freitas
  ];
BEGIN
